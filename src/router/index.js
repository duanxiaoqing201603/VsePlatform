...
export const constantRoutes = [
  ...
  /*{
    ...
    children: [
      {
        path: 'collegeMgr',
        component: () => import('@/views/college/collegeMgr/index'),
        meta: { title: '学院管理' },
        /!*children:[
          {
            path:'/collegeEdit',
            name:'CollegeEdit',
            component:()=>import('@/views/collegeEdit/index'),
          },
        ]*!/
      },
      {
        path: 'collegeMgr1',
        //component: () => import('@/views/college/collegeMgr1/index'),
        //meta: { title: '学院管理1' }
      },
      {
        path:'/collegeEdit',
  ...
  },*/
  {
    ...
    children: [
      ...
      },
      {
        ...
        name:'CollegeEdit',
        hidden:true,
        component:()=>import('@/views/college/collegeEdit/index'),
        meta: { title: '' }
      },
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name:'SubjectEdit',
        hidden:true,
        component:()=>import('@/views/subject/subjectEdit/index'),
        meta: { title: '' }
      },
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name:'ChapterEdit',
        hidden:true,
        component:()=>import('@/views/chapter/chapterEdit/index'),
        meta: { title: '' }
      },
      {
        path:'/note',
